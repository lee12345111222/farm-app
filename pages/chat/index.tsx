...
const Chat = () => {
    return (
        <div className="w-full h-full bg-[#F5F5F5] relative">
            ...
            <div className=" w-full flex items-center fixed bottom-0 left-0 h-[101px] bg-white pt-[14px] pl-[15px] pb-[45px]">
                <div className=" w-[272px] h-[40px] bg-[#F5F5F5] rounded-lg"></div>
