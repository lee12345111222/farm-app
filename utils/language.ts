export const language: Record<string, any> = {
  ...
  zh: {
    ...
    questionE: "E. Score 1 points for each “yes” answer.",
    questionE0: "寵物與雞舍隔離",
    questionE1: "我的雞場有良好的蒼蠅控製計畫",
    questionE2: "我的雞舍貫徹執行全場疾病控製措施",
    questionE3: "我經常參與培訓令自己跟上對疾病控製的新發展",
    submit: "提交",
